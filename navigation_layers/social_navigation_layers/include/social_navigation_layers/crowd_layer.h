#ifndef SOCIAL_NAVIGATION_LAYERS_CROWD_LAYER_H
#define SOCIAL_NAVIGATION_LAYERS_CROWD_LAYER_H
#include <ros/ros.h>
...
{
class CrowdLayer : public costmap_2d::Layer
{
public:
  CrowdLayer()
  {
...
#endif  // SOCIAL_NAVIGATION_LAYERS_CROWD_LAYER_H
