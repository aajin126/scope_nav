...
void SocialLayer::onInitialize()
{
  ...
  nh.param("people_topic", people_topic, std::string("sogmp_prediction"));
  people_sub_ = nh.subscribe("/" + people_topic, 1, &SocialLayer::peopleCallback, this);//nh.subscribe("/people", 1, &SocialLayer::peopleCallback, this);
}
